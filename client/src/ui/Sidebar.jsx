...
function Sidebar() {
  return (
    <aside className="w-[20%] flex flex-col gap-6 border-l-2 border-black/20 py-4 ">
      <NavLink className="border-l-2 flex items-center gap-2 rounded-sm p-3 text-sm font-semibold hover:bg-[#F8F9FA]">
